...
<head>
    ...
    <!-- Icon -->
    <link rel="icon" href="<?php echo e(asset('images/hotelinn/logo_circle.png')); ?>">
</head>
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white sticky-top shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    ...
                    <img src="<?php echo e(asset('images/hotelinn/brand.png')); ?>" width="100" height="100%" alt="">
                </a>
                                ...
                                <a class="dropdown-item"
                                    ...
                                    <a class="dropdown-item"
                                       onclick="event.preventDefault();
                                        ...
                                        <?php echo e(__('Riwayat Pemesanan')); ?>
...
<?php /**PATH D:\xampp\htdocs\hotelinn\resources\views/layouts/app.blade.php ENDPATH**/ ?>