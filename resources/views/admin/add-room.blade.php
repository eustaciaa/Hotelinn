                    ...
                    <div class="row">
                        ...
                        <div class="col pr-5">
                            <div class="form-group flex-column d-flex">
                                ...
                                <input type="text" name="shower" class="form-control @error('shower') is-invalid @enderror mb-3" placeholder="Fasilitas Kamar Mandi" value="{{ old('shower') }}" />
                                @error('shower')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="text" name="scenery" class="form-control @error('scenery') is-invalid @enderror mb-3" placeholder="Fasilitas Pemandangan" value="{{ old('scenery') }}" />
                                @error('scenery')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="text" name="entertainment" class="form-control @error('entertainment') is-invalid @enderror mb-3" placeholder="Fasilitas Hiburan" value="{{ old('entertainment') }}" />
                                @error('entertainment')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="text" name="convenience" class="form-control @error('convenience') is-invalid @enderror mb-3" placeholder="Fasilitas Kenyamanan Kamar" value="{{ old('convenience') }}" />
                                @error('convenience')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="text" name="furniture" class="form-control @error('furniture') is-invalid @enderror mb-3" placeholder="Fasilitas Perabotan Kamar" value="{{ old('furniture') }}" />
                                @error('furniture')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="text" name="service" class="form-control @error('service') is-invalid @enderror mb-3" placeholder="Fasilitas Layanan Kamar" value="{{ old('service') }}" />
                                @error('service')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="text" name="security_safety" class="form-control @error('security_safety') is-invalid @enderror mb-3" placeholder="Fasilitas Keamanan Kamar" value="{{ old('security_safety') }}" />
                                @error('security_safety')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="text" name="laundry" class="form-control @error('laundry') is-invalid @enderror mb-3" placeholder="Fasilitas Kebersihan Kamar" value="{{ old('laundry') }}" />
                                @error('laundry')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="text" name="food" class="form-control @error('food') is-invalid @enderror mb-3" placeholder="Fasilitas Makanan" value="{{ old('food') }}" />
                                @error('food')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
